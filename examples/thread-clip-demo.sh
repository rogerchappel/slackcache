...
node "$ROOT_DIR/dist/src/cli.js" search deploy --index "$CACHE_DIR" --channel general --limit 1 >"$OUT_DIR/search.txt"
node "$ROOT_DIR/dist/src/cli.js" thread 1777586400.000100 --index "$CACHE_DIR" --channel general >"$OUT_DIR/thread.txt"
